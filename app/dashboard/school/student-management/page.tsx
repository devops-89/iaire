...
const students = [
  { id: "S-101", name: "Alex Rivera", grade: "12th", mentor: "Dr. Sarah Johnson", status: "Active" },
  { id: "S-102", name: "Jordan Smith", grade: "11th", mentor: "Prof. Michael Chen", status: "Nominated" },
  { id: "S-103", name: "Casey Lee", grade: "12th", mentor: "Not Assigned", status: "Pending" },
];
        ...
        <Box sx={{ mb: 4, display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <Box>
            ...
            <Typography sx={{ fontFamily: montserrat.style.fontFamily, color: "rgba(0,0,0,0.6)" }}>
              Manage student mentors, recommend student leaders, and monitor academic progress.
            </Typography>
          </Box>
          <Button
            variant="contained"
            ...
            <Table>
              <TableHead sx={{ bgcolor: "rgba(11, 23, 39, 0.02)" }}>
                <TableRow>
                  ...
                  <TableCell sx={{ fontWeight: 700, fontFamily: montserrat.style.fontFamily }}>Mentor</TableCell>
              ...
              <TableBody>
                {students.map((item) => (
                  <TableRow key={item.id} hover>
                    ...
                    <TableCell sx={{ fontFamily: montserrat.style.fontFamily }}>{item.mentor}</TableCell>
                    <TableCell>
                      <Chip
                        label={item.status}
                        size="small"
                        sx={{
                          bgcolor: item.status === "Active" ? "rgba(16, 185, 129, 0.1)" : item.status === "Nominated" ? "rgba(245, 158, 11, 0.1)" : "rgba(107, 114, 128, 0.1)",
                          color: item.status === "Active" ? "#10B981" : item.status === "Nominated" ? "#F59E0B" : "#6B7280",
                          fontWeight: 700,
                          borderRadius: "6px",
                        }}
                      />
