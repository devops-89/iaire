          ...
          <Grid size={{ xs: 12, md: 6.5 }}>
            <Stack spacing={3.5} sx={{ textAlign: { xs: "center", md: "left" } }}>
              ...
              <Stack spacing={2} sx={{ color: "#9D9DA7", maxWidth: "580px" }}>
                ...
                >
                  <strong>IAIRE</strong> is an independent U.S. nonprofit academic and professional society incorporated in the State of Texas, dedicated to advancing innovation, research, and entrepreneurship education globally through standards development, certification frameworks, and peer-reviewed mentorship systems.
                </Typography>
                ...
                >
                  Governed by its own bylaws and peer-review processes, IAIRE adopts professional practices employed by established academic societies worldwide, with leadership oversight provided by its Scientific Board.
                </Typography>
              </Stack>
              ...
              >
                <Stack spacing={0.5}>
                  <Typography sx={{ fontFamily: inter.style.fontFamily, fontSize: "26px", fontWeight: 800, color: "#FFFFFF" }}>
                    150+
                  </Typography>
                  <Typography sx={{ fontFamily: inter.style.fontFamily, fontSize: "10.5px", fontWeight: 700, color: "#3B82F6", textTransform: "uppercase", letterSpacing: "0.05em" }}>
                    Innovation Hubs
                  </Typography>
                </Stack>
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  height: "95px",
                  borderRadius: "50%",
                  background: "radial-gradient(circle at 35% 35%, rgba(255, 255, 255, 0.1) 0%, rgba(27, 54, 93, 0.4) 40%, rgba(9, 10, 14, 0.95) 100%)",
                  border: "1px solid rgba(59, 130, 246, 0.35)",
                  boxShadow: "0 0 30px rgba(59, 130, 246, 0.25), inset 0 0 20px rgba(59, 130, 246, 0.2)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  animation: "pulse-glow 3s ease-in-out infinite",
                  "@keyframes pulse-glow": {
                    "0%, 100%": { boxShadow: "0 0 25px rgba(59, 130, 246, 0.25), inset 0 0 15px rgba(59, 130, 246, 0.15)" },
                    "50%": { boxShadow: "0 0 45px rgba(59, 130, 246, 0.4), inset 0 0 25px rgba(59, 130, 246, 0.3)" },
                  },
                }}
              >
                <Typography sx={{ fontFamily: "monospace", fontSize: "11px", fontWeight: 800, color: "#FFFFFF", letterSpacing: "0.15em" }}>
                  IAIRE
                </Typography>
              </Box>

              {/* Revolving Glassmorphic Badges on respective ring lines */}
              <RevolvingBadge label="Innovation" startAngle={0} radius={125} tiltX={60} tiltY={-15} speed={20} clockwise={true} />
              <RevolvingBadge label="Research" startAngle={180} radius={125} tiltX={60} tiltY={-15} speed={20} clockwise={true} />
              <RevolvingBadge label="Entrepreneurship" startAngle={90} radius={170} tiltX={60} tiltY={15} speed={25} clockwise={false} />
              <RevolvingBadge label="Patent Pathways" startAngle={270} radius={170} tiltX={60} tiltY={15} speed={25} clockwise={false} />
