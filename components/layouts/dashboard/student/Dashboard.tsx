...
const Dashboard = () => {
  ...
  const stepperData = [
    { label: "Fellow Student Member" },
    { label: "Chartered Student Member" },
    { label: "Accredited Student Member" },
    { label: "Student Member" },
  ];

  const STUDENT_STAT_SECTIONS = [
    {
      title: "Membership Status",
      data: [
        {
          title: "Membership Status",
          count: data?.approvalStatus || "Pending",
          icon: VerifiedUser,
        },
        {
          title: "Membership Code",
          count: membershipCode.length > 0 ? String(membershipCode[0]) : "N/A",
          icon: Star,
        },
      ],
    },
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: "1600px", mx: "auto" }}>
            ...
            >
              ...
              <Box sx={{ mt: 4 }}>
                ...
                >
                  ...
                  >
                    Progress to Accredited Student Member
                  </Typography>
                  <Typography
                    sx={{
                      fontFamily: roboto.style.fontFamily,
                ...
                >
                  Complete your academic profile and log your first project or
                  startup.
                </Typography>
              </Box>
            </Box>
      ...
      {/* Student Stats Sections */}
      <Box sx={{ mt: 6 }}>
        {STUDENT_STAT_SECTIONS.map((section, i) => (
