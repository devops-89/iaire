    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        <Grid container spacing={{ xs: 6, md: 8 }} alignItems="center">
          ...
          {/* Left Column: Custom Generated Illustration */}
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Stack spacing={3.5}>
              ...
              <Stack spacing={2.5}>
                ...
                >
                  IAIRE’s Top Young Innovator Competition is designed to identify, mentor, celebrate, and recognize outstanding student innovators from around the world.
                </Typography>
                <Typography
                  sx={{
                    fontFamily: inter.style.fontFamily,
                ...
                >
                  Unlike traditional competitions, IAIRE emphasizes learning before evaluation. Students first receive access to innovation resources, learning frameworks, mentoring, and project development support. They then showcase their solutions on a national and international platform.
                </Typography>
              </Stack>
