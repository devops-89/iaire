...
const OrangeCheck = () => (
  <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="10" fill="rgba(248, 93, 0, 0.15)" stroke="#F85D00" strokeWidth="2" />
          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Stack spacing={3.5}>
              ...
              <Stack spacing={2.5}>
                ...
                >
                  Every school has creative students. Every teacher has the potential to inspire innovation. Every institution can become a center of research, creativity, and entrepreneurship.
                </Typography>
                <Typography
                  sx={{
                    fontFamily: inter.style.fontFamily,
                ...
                >
                  But for innovation to thrive, schools need more than enthusiasm.{" "}
                ...
                >
                  Our approach helps schools move from isolated projects to a continuous innovation culture.
                </Typography>
              </Stack>
