...
const HeroSection = () => {
  ...
  return (
    <Box
      sx={{
        position: "relative",
        // background: `radial-gradient(${COLORS.PRIMARY_NAVY} 0%, ${COLORS.ACCENT_TAN} 100%)`,
        ...
        "&::after": {
          ...
          height: "60%",
          // background:
          //   "radial-gradient(circle, rgba(0, 255, 170, 0.05) 0%, rgba(0, 255, 170, 0) 70%)",
          filter: "blur(60px)",
          zIndex: 0,
        },
          ...
          >
            ...
            <Button
              ...
              sx={{
                ...
                bgcolor:
                  hovered === "primary" ? COLORS.ACCENT_TAN : "transparent",
