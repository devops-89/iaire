          ...
          <Grid size={{ xs: 12, md: 7.5 }} sx={{ order: { xs: 2, md: 1 } }}>
            <Grid container spacing={2.5}>
              ...
              <Grid size={{ xs: 12, sm: 8 }} sx={{ display: "flex" }}>
                ...
                >
                  <Box sx={{ alignSelf: "flex-start", backgroundColor: "rgba(248, 93, 0, 0.12)", color: "#F85D00", px: 1.5, py: 0.5, borderRadius: "6px", fontSize: "10px", fontWeight: 700, fontFamily: "monospace", letterSpacing: "0.1em" }}>
                    ECOSYSTEM
                  </Box>
                  <Typography sx={{ fontFamily: inter.style.fontFamily, fontSize: "16px", fontWeight: 700, color: "#E2E2E9", mt: 4, lineHeight: 1.4 }}>
              ...
              <Grid size={{ xs: 12, sm: 4 }} sx={{ display: "flex" }}>
                ...
                >
                  <Box sx={{ width: 40, height: 40, borderRadius: "8px", backgroundColor: "rgba(248, 93, 0, 0.08)", display: "flex", alignItems: "center", justifyItems: "center", justifyContent: "center" }}>
                    <PatentIcon />
                  </Box>
                  <Typography sx={{ fontFamily: inter.style.fontFamily, fontSize: "14px", fontWeight: 700, color: "#E2E2E9", mt: 3, lineHeight: 1.4 }}>
              ...
              <Grid size={{ xs: 12, sm: 6 }} sx={{ display: "flex" }}>
                ...
                >
                  <Box sx={{ display: "inline-block", backgroundColor: "rgba(248, 93, 0, 0.12)", color: "#F85D00", px: 1, py: 0.25, borderRadius: "4px", fontSize: "9px", fontWeight: 700, fontFamily: "monospace", letterSpacing: "0.05em", mb: 2 }}>
                    CULTURE
                  </Box>
                  <Typography sx={{ fontFamily: inter.style.fontFamily, fontSize: "14px", fontWeight: 700, color: "#E2E2E9", lineHeight: 1.4 }}>
          ...
          <Grid size={{ xs: 12, md: 4.5 }} sx={{ order: { xs: 1, md: 2 } }}>
            <Stack spacing={3.5}>
              ...
              <Stack spacing={2.5}>
                ...
                >
                  IAIRE helps schools establish Innovation Hubs that become the center of creativity, research, innovation, and entrepreneurship within the institution.
                </Typography>
                <Typography
                  sx={{
                    fontFamily: inter.style.fontFamily,
                ...
                >
                  ...
                  led by trained teachers and supported by IAIRE resources, mentoring frameworks, digital tools, and student programs.
                </Typography>
              </Stack>
