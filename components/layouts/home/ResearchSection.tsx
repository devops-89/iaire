...
const ScienceIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F85D00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Stack spacing={3.5}>
              ...
              <Stack spacing={2.5}>
                ...
                >
                  IAIRE supports the complete innovation lifecycle — from idea to impact.
                </Typography>
                <Typography
                  sx={{
                    fontFamily: inter.style.fontFamily,
                ...
                >
                  Promising student and teacher innovations may be guided toward research publication, patentability assessment, patent filing, technology development, and entrepreneurial exploration, subject to applicable guidelines and laws.
                </Typography>
                <Typography
                  sx={{
                    fontFamily: inter.style.fontFamily,
                ...
                >
                  IAIRE encourages students to think beyond projects and begin understanding how ideas can become:
                </Typography>
                <Typography
                  sx={{
                    fontFamily: inter.style.fontFamily,
                ...
                >
                  We believe innovation education becomes truly powerful when students learn how ideas move from imagination to implementation.
                </Typography>
              </Stack>
