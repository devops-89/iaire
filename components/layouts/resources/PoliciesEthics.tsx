          ...
          >
            <Stack spacing={3.25} sx={{ width: "100%" }}>
              ...
              <Stack spacing={1.5} data-aos="fade-up" data-aos-duration="800">
                ...
                >
                  The program operates on the principle that student safety,
                  privacy, wellbeing, and ethical participation take precedence
                  over all innovation, research, and entrepreneurship
                  activities.
                </Typography>
              </Stack>
