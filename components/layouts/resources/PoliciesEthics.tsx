...
import heroImg from "@/public/images/resources/policies_ethics.png";
...
const principles = [
  ...
  "Proper recognition of inventorship & authorship",
  "Confidential handling of intellectual property",
];

const PoliciesEthics = () => {
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, height: "100%", display: "flex", alignItems: "center" }}>
        <Grid container spacing={{ xs: 6, md: 6 }} alignItems="center">
          ...
          {/* Left Column: Visual Safeguarding Illustration (ordered first on desktop, second on mobile) */}
          <Grid
            size={{ xs: 12, md: 5 }}
            order={{ xs: 2, md: 1 }}
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src={heroImg}
                  alt="IAIRE Policies and Ethical Standards data privacy child safeguarding illustration"
                  fill
          ...
          {/* Right Column: Title, Details, Grid of Principles & CTA Buttons (ordered second on desktop, first on mobile) */}
          <Grid size={{ xs: 12, md: 7 }} order={{ xs: 1, md: 2 }} sx={{ pl: { md: 4 } }}>
            <Stack spacing={3.25} sx={{ width: "100%" }}>
              ...
              <Stack spacing={1.5}>
                ...
                >
                  Policies & <br />
                  <span style={{ color: "#1B365D" }}>Ethical Standards</span>
                </Typography>
                ...
                >
                  Student Protection, Data Governance, and Ethical Participation
                </Typography>
                ...
                >
                  The program operates on the principle that student safety, privacy, wellbeing, and ethical participation take precedence over all innovation, research, and entrepreneurship activities.
                </Typography>
              </Stack>

              {/* Symmetrical 2-Column Grid of Principles */}
              <Stack spacing={1.5}>
                <Typography
                  sx={{
                    fontFamily: inter.style.fontFamily,
