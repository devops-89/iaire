...
const trainingAreas = [
  ...
  "Creativity & idea generation pedagogy",
  "Research fundamentals & problem identification",
  "Mentoring methodologies & support",
  "Innovation project management",
  "Documentation & publishing standards",
  "Student assessment frameworks",
  "Continuous academic support & progression",
];

const EducatorDevelopment = () => {
...
export default EducatorDevelopment;
