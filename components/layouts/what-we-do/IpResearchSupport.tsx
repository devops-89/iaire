          ...
          <Grid size={{ xs: 12, md: 6.8 }}>
            <Stack spacing={2.75} sx={{ width: "100%" }}>
              ...
              <Stack spacing={1}>
                ...
                >
                  A distinguishing feature of the <strong>IAIRE</strong> ecosystem is its commitment to supporting the complete innovation lifecycle from ideation to intellectual property creation and research dissemination.
                </Typography>
              </Stack>
              ...
              >
                ...
                >
                  <strong>IAIRE</strong> and <strong>DiscoverSTEM</strong> do not retain, acquire, or claim ownership rights over patents, publications, innovations, copyrights, trademarks, designs, data, or any other intellectual property generated by students, teachers, or schools participating in the program.
                </Typography>
              </Card>
